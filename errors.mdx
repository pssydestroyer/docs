...
<ResponseField name="4xx (except 429)" required="false" deprecated="false">
  Client error — fix the request. Do not blind-retry; the same call fails again.
</ResponseField>

<ResponseField name="429" required="false" deprecated="false">
  Back off and retry with exponential backoff.
</ResponseField>

<ResponseField name="5xx" required="false" deprecated="false">
